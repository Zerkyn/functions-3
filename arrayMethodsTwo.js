...
// CODE HERE
const newNums = numbers.map(e => e / 2)
...
// CODE HERE
const endsWith = cities.filter(e => {
  return e.endsWith('i')
})
...
// CODE HERE
fruits.forEach((e, i) => {
  e.name === 'apple' || e.color === 'orange' ?
    e.color === 'red' ? console.log(`The fruit with index ${i} is an apple`)
      : console.log(`The fruit with index ${i} is an orange`)
    : console.log(`The fruit with index ${i} is neither apple or orange`)


  // if (e.name === 'apple' || e.color === 'orange') {
  //   if (e.color === 'red') {
  //     console.log(`The fruit with index ${i} is an apple`)
  //   } console.log(`The fruit with index ${i} is an orange`)
  // }else console.log(`The fruit with ${i} is neither apple or orange`)
})
...
let withRice = []
foods.map(e => {
  e.tags.includes('rice') ? withRice.push(e) : null
})

// THE TOTAL
console.log(withRice.reduce((a, c) => { return a + c.price }, 0))
